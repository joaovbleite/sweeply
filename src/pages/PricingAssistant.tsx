        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {serviceTypeOptions.map((option) => {
                  ...
                  return (
                    <button
                      key={option.value}
                      onClick={() => setServiceType(option.value as 'residential' | 'commercial')}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <select
                value={cleaningType}
                onChange={(e) => setCleaningType(e.target.value as 'regular' | 'deep_clean' | 'move_in' | 'move_out' | 'post_construction' | 'one_time')}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={urgency}
                    onChange={(e) => setUrgency(e.target.value as 'standard' | 'same_day' | 'next_day')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pulse-500 focus:border-transparent"
                  >
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      pricingCalculation.market.demand === 'high' ? 'bg-blue-100 text-blue-600' : 'bg-yellow-100 text-yellow-800'
                    }`}>
                ...
                <div className={`p-4 rounded-lg ${
                  pricingCalculation.marketPosition === 'competitive' ? 'bg-blue-50 border border-blue-200' :
              ...
              <div className="space-y-3">
                {pricingCalculation.recommendations.map((rec, index) => (
                  <div key={index} className={`p-4 rounded-lg border ${
                    rec.type === 'success' ? 'bg-blue-50 border-blue-200' :
