  ...
  return (
    <AppLayout>
      <PageHeader
        ...
        rightElement={
          <div className="flex items-center gap-2">
            <button className="px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center gap-2 transition-colors text-xs sm:text-sm">
      ...
      <div className="flex flex-col h-full bg-gray-50">
        <Tabs defaultValue="dashboard" value={activeTab} onValueChange={setActiveTab} className="w-full px-4 py-3">
