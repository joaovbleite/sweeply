...
import { Employee, UpdateEmployeeInput, EmployeeRole, PayrollFrequency, PaymentMethod, EmployeeStatus } from "@/types/employee";
...
const EditEmployee = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!id || !formData.first_name || !formData.last_name || !formData.email || !formData.hourly_rate) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-display font-bold text-gray-900 flex items-center gap-3">
                <UserCheck className="w-8 h-8 text-pulse-600" />
                Edit Employee
              </h1>
              <p className="mt-1 text-gray-600">Update {employee.first_name} {employee.last_name}'s information</p>
            </div>
          </div>
        </div>
