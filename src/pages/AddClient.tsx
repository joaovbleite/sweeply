              ...
              <div className="flex-1 flex flex-col space-y-4">
                ...
                <div className="flex items-center justify-between px-2">
                  ...
                  <button 
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full focus:outline-none ${receivesSMS ? 'bg-blue-600' : 'bg-gray-300'}`}
                  >
                    <span 
                ...
                <button 
                  className="text-blue-600 font-medium text-left w-full py-2"
