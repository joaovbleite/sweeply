...
const FloatingActionMenu: React.FC = () => {
  ...
  return (
    <>
      ...
      <button
        className={`fab-button fixed right-6 bottom-[5.5rem] z-50 bg-[#1a2e35] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg transform transition-all duration-300 ${isOpen ? 'rotate-45' : ''}`}
      ...
      >
        <div 
          className="floating-menu-container fixed right-6 bottom-[5.5rem] z-50 flex flex-col-reverse items-end space-y-reverse space-y-3 pb-16"
