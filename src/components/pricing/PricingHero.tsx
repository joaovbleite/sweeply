...
const PricingHero: React.FC<PricingHeroProps> = ({ isAnnual, setIsAnnual }) => {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-emerald-500 to-emerald-700 text-white animate-on-scroll">
      <div className="section-container text-center">
        ...
        <p className="section-subtitle !text-emerald-100 max-w-2xl mx-auto mb-8 sm:mb-10">
          Scale your cleaning business with the right tools. Simple, transparent pricing to fit your needs.
        </p>
        <div className="flex items-center justify-center space-x-3">
          <Label htmlFor="billing-cycle" className="text-lg font-medium text-emerald-100">
            Monthly
          </Label>
          <Switch
            id="billing-cycle"
            ...
            className="data-[state=checked]:bg-orange-500 data-[state=unchecked]:bg-emerald-400"
          />
          <Label htmlFor="billing-cycle" className="text-lg font-medium text-emerald-100 relative">
            Annually
            {isAnnual && (
