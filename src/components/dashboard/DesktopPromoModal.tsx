  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex flex-col overflow-y-auto">
      ...
      <div className="flex-1 px-6 pb-8 overflow-y-auto">
        <h1 className="text-3xl font-bold text-[#1a2e35] mt-6 mb-8">
        ...
        <div className="relative mb-8">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              ...
              <div className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
                ...
                <div className="flex gap-1 mt-2">
                  ...
                  <div className="h-8 w-8 bg-green-600 rounded flex items-center justify-center text-white text-xs">1h</div>
                  <div className="h-8 w-8 bg-gray-200 rounded"></div>
                  <div className="h-8 w-8 bg-gray-200 rounded"></div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <div className="ml-auto bg-green-600 w-10 h-6 rounded-full flex items-center justify-end px-1">
          ...
          <div className="absolute -top-3 -left-3">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 25L10 15L15 10L25 5" stroke="#8AE234" strokeWidth="3" strokeLinecap="round"/>
            </svg>
          </div>
        </div>
        ...
        <button 
          onClick={onClose}
          className="w-full bg-green-600 text-white py-4 rounded-md text-lg font-medium"
        >
          Got it
        </button>
      </div>
