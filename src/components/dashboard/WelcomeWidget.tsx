...
const WelcomeWidget = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-pulse-500 to-blue-700 rounded-none sm:rounded-xl md:rounded-2xl p-3 sm:p-5 md:p-6 text-white shadow-xl relative overflow-hidden mt-24 sm:mt-16 md:mt-12 -mx-4 sm:mx-0 w-[calc(100%+32px)] sm:w-auto">
