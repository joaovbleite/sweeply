...
const WelcomeWidget = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-pulse-500 to-blue-700 rounded-0 sm:rounded-xl md:rounded-2xl p-3 sm:p-5 md:p-6 text-white shadow-xl relative overflow-hidden mt-2 sm:mt-3 md:mt-2 mx-0">
