...
const WelcomeWidget = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 to-blue-700 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white shadow-lg relative overflow-hidden mt-3 sm:mt-4 md:mt-5 mx-3 sm:mx-4 md:mx-6">
      ...
      <div className="flex items-start justify-between mb-4 sm:mb-5 md:mb-6">
        <div className="flex-1 pr-14 sm:pr-20 md:pr-32">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2 md:mb-3 leading-tight">
      ...
      <div className="border-t border-white/20 pt-3 sm:pt-4 md:pt-5">
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between items-start">
          {/* Quick Actions */}
          <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 mt-0">
            <Link 
              to="/jobs/new" 
              className="bg-white/20 hover:bg-white/30 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 rounded-lg flex items-center gap-1.5 sm:gap-2 md:gap-2.5 transition-all duration-200 backdrop-blur-sm text-xs sm:text-sm md:text-base"
            >
          ...
          {/* Daily Business Tip */}
          <div className="flex items-center gap-1.5 bg-white/10 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg backdrop-blur-sm w-full sm:w-auto mt-2 sm:mt-0">
