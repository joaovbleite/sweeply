...
import { TrendingUp, Target, Zap, Plus, Calendar, Users, Lightbulb, Bell } from 'lucide-react';
...
const WelcomeWidget = () => {
  ...
  const quotes = [
    ...
    { text: "A clean space is a happy place!", icon: TrendingUp },
      ...
      <div className="border-t border-white/20 pt-3 sm:pt-4 md:pt-5">
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between items-start">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 mt-0">
            <Link 
              to="/jobs/new" 
              className="bg-white/20 hover:bg-white/30 px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 md:py-3 rounded-lg flex items-center gap-1.5 sm:gap-2 md:gap-2.5 transition-all duration-200 backdrop-blur-sm text-xs sm:text-sm md:text-base"
            >
          ...
          {/* Daily Business Tip */}
          <div className="flex items-center gap-2 bg-white/10 px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 md:py-3 rounded-lg backdrop-blur-sm w-full sm:w-auto mt-2 sm:mt-0">
