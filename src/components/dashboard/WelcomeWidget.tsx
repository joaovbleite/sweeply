...
const WelcomeWidget = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-pulse-500 to-blue-700 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white shadow-xl relative overflow-hidden">
      {/* Top right icons - improved for mobile */}
      <div className="absolute top-4 right-4 flex items-center gap-2 sm:gap-2.5 md:gap-3">
        {/* Star Icon */}
      ...
      <div className="flex items-start justify-between mb-4 sm:mb-5 md:mb-6">
        <div className="flex-1 pr-16 sm:pr-20 md:pr-32">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-1.5 md:mb-2 leading-tight">
          ...
          <div className="flex items-center gap-2 mb-2.5 sm:mb-3 md:mb-4">
            <QuoteIcon className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5" />
            <p className="text-sm sm:text-base md:text-lg opacity-90">{todayQuote.text}</p>
          </div>
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-[11px] sm:text-xs md:text-sm">
            <div>
      ...
      <div className="border-t border-white/20 pt-3 sm:pt-3.5 md:pt-4">
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between items-start">
          {/* Quick Actions */}
          <div className="flex flex-wrap gap-2 sm:gap-2.5 md:gap-3 mt-0.5">
            <Link 
              to="/jobs/new" 
              className="bg-white/20 hover:bg-white/30 px-3 sm:px-3.5 md:px-4 py-1.5 sm:py-2 md:py-2.5 rounded-lg flex items-center gap-1.5 sm:gap-2 md:gap-2.5 transition-all duration-200 backdrop-blur-sm text-xs sm:text-sm md:text-base"
            >
          ...
          {/* Daily Business Tip */}
          <div className="flex items-center gap-2 bg-white/10 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg backdrop-blur-sm w-full sm:w-auto mt-2 sm:mt-0">
            <Lightbulb className="w-4 h-4 min-w-[16px] text-yellow-300" />
